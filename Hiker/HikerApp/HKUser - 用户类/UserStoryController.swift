...
class UserStoryController: SubClassBaseViewController {
    public var count = 10
...
//        }
    ...
    func configUI(){
        ...
        self.tableView.frame = CGRect(x: 0, y: 0, width: TKWidth, height: TKHeight)
         self.navigation.item.title =  "“\(word)”的游记"
...
extension UserStoryController: UITableViewDelegate,UITableViewDataSource {
