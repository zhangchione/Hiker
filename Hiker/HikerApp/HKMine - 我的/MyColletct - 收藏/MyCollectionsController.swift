...
class MyCollectionsController: UIViewController {
...
//    }
    ...
    func configData() {
        ...
        Alamofire.request(getMyCollectionsAPI()).responseJSON { (response) in
...
extension MyCollectionsController: UICollectionViewDelegateFlowLayout, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        headerView.titleLabel.text = "有\(data.count)个关于我收藏的故事。"
